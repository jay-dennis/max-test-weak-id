classdef class_tests_9991 < class_dgp_9991
...
%         wald_orig_test_stat
    ...
    methods
        ...
        function obj = class_tests_9991(dgp_type, hypothesis_type, n, seed_input, k_lambda, k_delta, beta_in, k_lambda_n)
            obj@class_dgp_9991(dgp_type, hypothesis_type, n, seed_input, k_lambda, k_delta, beta_in);
        ...
        function obj = fcn_tests_initial(obj)
            Y = obj.Y0;
            X = [obj.x_delta; obj.x_lambda; obj.x_pi];
        ...
        function [V_hat, V_hat_lambda] = fcn_V_hat(obj, theta_in, X_in, Y, type, type_exclude_beta)
            ...
            elseif type == 1
                ...
                for i = 1:obj.k_lambda
                    ...
                    X = X_in(ind_pars, :);          % [X_in(1:obj.k_delta,:); X_in(obj.k_delta+i,:)];
                    l_K = [];
